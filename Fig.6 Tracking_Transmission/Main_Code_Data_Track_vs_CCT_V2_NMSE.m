...
N_BS_Comp_h_del = 1; N_BS_Comp_v_del = N_BS_Comp_h_del;
...
N_AC_Comp_h_del = 1; N_AC_Comp_v_del = N_AC_Comp_h_del;
...
NMSE_set_Notr = zeros(L,N_OFDM_tot);
NMSE_set_EDD = zeros(L,N_OFDM_tot);
NMSE_set_EDD_CCEDC = zeros(L,N_OFDM_tot);
...
for ii = 1:N_CCT
    ...
    for mm_nmse = 1:N_OFDM_C
        for ll_data_nmse = 1:L
            NMSE_set_Notr(ll_data_nmse,(ii-1)*N_OFDM_C+mm_nmse) = norm(h_vec_real_set_temp(:,ll_data_nmse,mm_nmse) - ...
                h_vec_init_est_set_0(:,ll_data_nmse))^2/norm(h_vec_real_set_temp(:,ll_data_nmse,mm_nmse))^2;
            NMSE_set_EDD(ll_data_nmse,(ii-1)*N_OFDM_C+mm_nmse) = norm(h_vec_real_set_temp(:,ll_data_nmse,mm_nmse) - ...
                Est_eff_Chan_DD_EDD_CCEDC_ii(:,ll_data_nmse,1,mm_nmse+1))^2/norm(h_vec_real_set_temp(:,ll_data_nmse,mm_nmse))^2;
            NMSE_set_EDD_CCEDC(ll_data_nmse,(ii-1)*N_OFDM_C+mm_nmse) = norm(h_vec_real_set_temp(:,ll_data_nmse,mm_nmse) - ...
                Est_eff_Chan_DD_EDD_CCEDC_ii(:,ll_data_nmse,2,mm_nmse+1))^2/norm(h_vec_real_set_temp(:,ll_data_nmse,mm_nmse))^2;
        end
    end
...
NMSE_set_Notr_used_dB = 10*log10(mean(NMSE_set_Notr(:,1:N_OFDM_tot_used)));
NMSE_set_EDD_used_dB = 10*log10(mean(NMSE_set_EDD(:,1:N_OFDM_tot_used)));
NMSE_set_EDD_CCEDC_used_dB = 10*log10(mean(NMSE_set_EDD_CCEDC(:,1:N_OFDM_tot_used)));
...
Fontsize = 15;
figure
plot(n_OFDM_tot_used,NMSE_set_Notr_used_dB,'-b','LineWidth',LineWidth); hold on; grid on;
plot(n_OFDM_tot_used,NMSE_set_EDD_used_dB,'-r','LineWidth',LineWidth+1);
plot(n_OFDM_tot_used,NMSE_set_EDD_CCEDC_used_dB,'-k','LineWidth',LineWidth);
...
h2 = legend('No tracking','DADD','DADD CCEDC','Location','southwest');
set(h2,'Fontsize',11);
