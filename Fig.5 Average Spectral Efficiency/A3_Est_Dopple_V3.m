function [Est_niu_Doppler,Est_Doppler_set] = A3_Est_Dopple_V3(H_Beam_Alignment_Doppler,G_ls_init,alpha_init,Doppler_init_k_set,...
    ...
    Est_Doppler_set_temp = zeros(L,Adjust_num);
    for ad_num = 1:Adjust_num
        if  ad_num == 1
            for ll_dop_est1 = 1:L
                Est_Doppler_set_temp(ll_dop_est1,ad_num) = TLS_ESPRIT_Algorithm(Y_dop_bar_set(:,:,ll_dop_est1),1, T_sym);
            end
        elseif ad_num == 2
            for ll_dop_est2 = 1:L
                ...
                Est_Doppler_set_temp(ll_dop_est2,ad_num) = TLS_ESPRIT_Algorithm(Y_dop_bar_ll_2,1, T_sym);
            end
            radial_vt_BS_set_init_est = Est_Doppler_set_temp(:,ad_num)*lambda_z;
        else
            for ll_dop_est3 = 1:L
                ...
                Est_Doppler_set_temp(ll_dop_est3,ad_num) = TLS_ESPRIT_Algorithm(Y_dop_bar_ll_3,1, T_sym);
            end
        end
    end
    Est_Doppler_set = Est_Doppler_set_temp(:,Adjust_num);
