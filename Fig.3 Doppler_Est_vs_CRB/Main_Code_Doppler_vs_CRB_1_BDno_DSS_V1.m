...
H_Beam_Alignment_Doppler_0 = zeros(1,L);
...
for ll_dop1 = 1:L
    ...
    H_Beam_Alignment_Doppler_0(:,ll_dop1) = Equ_a_AC_ll_init*Equ_a_BS_ll_init;
end
...
for ii = 1:length(SNR_dBs)
    ...
    tic
    for iter = 1:iterMax
        [Est_niu_Doppler_0,Est_Doppler_set_0,Y_dop_bar_set_0] = A3_Est_Dopple_V1(H_Beam_Alignment_Doppler_0,G_ls_init,alpha_init,Phase_Doppler_Dop_set,...
        ...
        if iter == 1
            ...
            for ll_crb_dop2 = 1:L
                Tx_eff_Dop_set_ll = alpha_init(ll_crb_dop2)*H_Beam_Alignment_Doppler_0(ll_crb_dop2)*...
        ...
        Adjust_num = 3;
        [Est_niu_Doppler_123,Est_Doppler_set_123,Y_dop_bar_set_123] = A3_Est_Dopple_V2(H_Beam_Alignment_Doppler_0,G_ls_init,alpha_init,Doppler_init_k_set,...
...
save Z1_Save_Doppler_CRB_v0_BDno_V1_1.mat SNR_dBs CRB_Doppler_set MSE_Doppler_set_0 MSE_Doppler_set_1 MSE_Doppler_set_2 MSE_Doppler_set_3
MarkerSize = 3;
LineWidth = 1.2;
Fontsize = 15;
